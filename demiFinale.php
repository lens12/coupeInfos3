  ...
  <div id="table"> 
   ...
   <form action="" method="post">
    ...
    <?php if(isset($_POST['match13']) && ($_SESSION['dFInfo']['etat1'])){
      $_SESSION['dFInfo']['dfscoreEQuipe1A'] =$equipe1;
      $_SESSION['dFInfo']['dfscoreEQuipe2B']=$equipe2;
   ...
   ?> id="dfm2">
    ...
    <?php if(isset($_POST['match14']) && ($_SESSION['dFInfo']['etat2'])){
      $_SESSION['dFInfo']['dfscoreEQuipe1B'] =$equipe1;
      $_SESSION['dFInfo']['dfscoreEQuipe2A']=$equipe2;
