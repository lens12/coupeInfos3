...
<!-- Creation de table groupe et en tete du  tableau  -->
        ...
        <td>
          ...
          <?php if(isset($_POST['match1']) &&  $_SESSION['matchUn']==false){
              $_SESSION['equipeUnGroupeA']["scores"][0]=$equipe1;
              $_SESSION['equipeDeuxGroupeA']["scores"][0]=$equipe2; 
...
<!-- conditions et repartition pour le match 2  -->
        ...
        if(isset($_POST['match2']) &&  $_SESSION['matchDeux']==false){
            $_SESSION['equipeTroisGroupeA']["scores"][0]=$equipe1;
            $_SESSION['equipeQuatreGroupeA']["scores"][0]=$equipe2; 
...
<!-- script pour desactiver le button  -->
        ...
        if(isset($_POST['match3']) &&  $_SESSION['matchTrois']==false){
            $_SESSION['equipeUnGroupeA']["scores"][1]=$equipe1;
            $_SESSION['equipeTroisGroupeA']["scores"][1]=$equipe2; 
...
<!-- conditions et repartition pour le match 4  -->
        ...
        if(isset($_POST['match4']) &&  $_SESSION['matchQuatre']==false){
            $_SESSION['equipeDeuxGroupeA']["scores"][1]=$equipe1;
            $_SESSION['equipeQuatreGroupeA']["scores"][1]=$equipe2; 
...
<!-- script pour desactiver le button  -->
        ...
        if(isset($_POST['match5']) &&  $_SESSION['matchCinq']==false){
            $_SESSION['equipeUnGroupeA']["scores"][2]=$equipe1;
            $_SESSION['equipeQuatreGroupeA']["scores"][2]=$equipe2; 
        ...
        if(isset($_POST['match6']) &&  $_SESSION['matchSix']==false){
            $_SESSION['equipeDeuxGroupeA']["scores"][2]=$equipe1;
            $_SESSION['equipeTroisGroupeA']["scores"][2]=$equipe2; 
...
<!-- conditions et repartition pour le match 8  -->
        ...
        if(isset($_POST['match7']) &&  $_SESSION['matchSept']==false){
            ...
            <?php
              $_SESSION['equipeUnGroupeB']["scores"][0]=$equipe1;
              $_SESSION['equipeDeuxGroupeB']["scores"][0]=$equipe2;
...
<!-- conditions et repartition pour le match 8  -->
        ...
        if(isset($_POST['match8']) &&  $_SESSION['matchHuit']==false){
          ...
          <?php
            $_SESSION['equipeTroisGroupeB']["scores"][0]=$equipe1;
            $_SESSION['equipeQuatreGroupeB']["scores"][0]=$equipe2; 
...
<!-- Match 9  -->
        ...
        if(isset($_POST['match9']) &&  $_SESSION['matchNeuf']==false){
          ...
          <?php
            $_SESSION['equipeUnGroupeB']["scores"][1]=$equipe1;
            $_SESSION['equipeTroisGroupeB']["scores"][1]=$equipe2; 
...
<!-- script pour desactiver le button  -->
        ...
        if(isset($_POST['match10']) &&  $_SESSION['matchDix']==false){
          ...
          <?php
            $_SESSION['equipeDeuxGroupeB']["scores"][1]=$equipe1;
            $_SESSION['equipeQuatreGroupeB']["scores"][1]=$equipe2; 
...
<!-- match 11  -->
        ...
        if(isset($_POST['match11']) &&  $_SESSION['matchOnze']==false){
          ...
          <?php
            $_SESSION['equipeUnGroupeB']["scores"][2]=$equipe1;
            $_SESSION['equipeQuatreGroupeB']["scores"][2]=$equipe2; 
...
<!-- Match 12  -->
        ...
        if(isset($_POST['match12']) &&  $_SESSION['matchDouze']==false){
            ...
            $_SESSION['equipeDeuxGroupeB']["scores"][2]=$equipe1;
            $_SESSION['equipeTroisGroupeB']["scores"][2]=$equipe2; 
